                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                >
                                    ...
                                    <option value="1">Show Available Item</option>
                                    <option value="2">Show Unavailable Item</option>
                                </select>
                            </div>
                            <div class="col-sm-2">
                                <select
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td style="width: 45px">
                                    ...
                                    >
                                        <i
                                            class="fas fa-times fa-lg text-danger mt-1 px-1"
                                        ></i>
                                    </a>
                                    <a
                                        v-else
                                    ...
                                    >
                                        <i
                                            class="fas fa-check fa-lg text-success mt-1"
                                        ></i>
                                    </a>
                                </td>
                            </tr>
...
export default {
    ...
    methods: {
        ...
        disabledAll() {
            swal.fire({
                title: "Confirmation",
                text: "Do you want to  disable selected item?",
                icon: "question",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
