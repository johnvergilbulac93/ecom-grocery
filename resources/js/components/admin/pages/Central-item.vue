                    ...
                    <tbody>
                        ...
                        >
                            <td style="width: 50px">
                                <a
                                    @click="
                                        preview(item.image, item.product_name)
                                    "
                            ...
                            <td style="width: 50px">
                                <a
                                    @click="
                                        uploadImageItem(item, item.product_id)
                                    "
                                    v-if="item === selectedData"
                                    class="text-danger"
                                    data-toggle="tooltip"
                                ...
                                >
                                    <i
                                        class="fas fa-cloud-upload-alt fa-lg text-primary mt-2"
                                    ></i
                                ></a>
                                <!-- <Button
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="uploadimageitem">
                            Upload Image
                        </h5>
                        <button
                            type="button"
                                ...
                                <div class="col-md-12 mt-1">
                                    <div class="custom-file">
                                        ...
                                        <label
                                            ...
                                            >Choose file</label
                                        >
                                        <div class="help-block invalid-feedback" v-if="errors.item_image">{{ errors.item_image[0] }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        ...
        uploadItemImage(itemcode) {
            ...
            axios.post("/api/imageitem", formData,{
                headers: {
